...
<div className="ModalMenu">
  ...
  <i className="uil uil-search"></i> 
    ...
    <li className="nav-item active">
        <Link className="nav-link nav-link" to="/Aktsiya">Акции </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link nav-link" to="/Katalog">Каталлог</Link>
      </li>
      <li className="nav-item ">
        <Link className="nav-link nav-link" to="/Dastafka">Доставка </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link nav-link" to="/About">О магазине</Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link nav-link" to="/Blog">Блог</Link>
      </li>
      </ul>
  </div>
</div>
