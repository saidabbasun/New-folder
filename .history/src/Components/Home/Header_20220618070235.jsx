...
<div className="ModalMenu">
  ...
  <i className="uil uil-search"></i> 
    ...
    <li className="nav-item active">
        <Link className="nav-link naL
        ink" to="/Aktsiya">Акции </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link naL
        ink" to="/Katalog">Каталлог</Link>
      </li>
      <li className="nav-item ">
        <Link className="nav-link naL
        ink" to="/Dastafka">Доставка </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link naL
        ink" to="/About">О магазине</Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link naL
        ink" to="/Blog">Блог</Link>
      </li>
      </ul>
  </div>
</div>
