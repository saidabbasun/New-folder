...
<div className="ModalMenu">
  ...
  <i className="uil uil-search"></i> 
    ...
    <li className="nav-item active">
        <Link className="nav-link naink" to="/Aktsiya">Акции </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link naink" to="/Katalog">Каталлог</Link>
      </li>
      <li className="nav-item ">
        <Link className="nav-link naink" to="/Dastafka">Доставка </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link naink" to="/About">О магазине</Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link naink" to="/Blog">Блог</Link>
      </li>
      </ul>
  </div>
</div>
