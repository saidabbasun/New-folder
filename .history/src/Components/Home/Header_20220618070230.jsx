...
<div className="ModalMenu">
  ...
  <i className="uil uil-search"></i> 
    ...
    <li className="nav-item active">
        <Link className="nav-link navink" to="/Aktsiya">Акции </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link navink" to="/Katalog">Каталлог</Link>
      </li>
      <li className="nav-item ">
        <Link className="nav-link navink" to="/Dastafka">Доставка </Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link navink" to="/About">О магазине</Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link navink" to="/Blog">Блог</Link>
      </li>
      </ul>
  </div>
</div>
