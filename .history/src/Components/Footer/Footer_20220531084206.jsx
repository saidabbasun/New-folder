      ...
      <div className="List">
        <ul>
           <Link className="link " to="/"> <li>Популярное</li></Link>
              <Link className="link " to="/"> <li>Книги для детей</li>
              <Link className="link " to="/"> <li> Программирование</li>
              <Link className="link " to="/"> <li> Психология</li>
              <Link className="link " to="/"> <li> Бизнес</li>
        </ul>
        <ul>
              <Link className="link " to="/"> <li>  Доставка  </li>
              <Link className="link " to="/"> <li>Информация</li>
              <Link className="link " to="/"> <li> Оплата</li>
              <Link className="link " to="/"> <li>  O магазине</li>
           
        </ul>
        <ul>
              <Link className="link " to="/"> <li>Помощь</li>
              <Link className="link " to="/"> <li>  Контакты</li>
              <Link className="link " to="/"> <li> Возврат товара</li>
              <Link className="link " to="/"> <li> Помощь покупателю</li>
