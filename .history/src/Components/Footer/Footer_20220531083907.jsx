  ...
  return (
    <div className='Footer'>
       ...
       <img src={Logo} alt="" />
        ...
        <Link className="link" to="/Aktsiya">Каталлог </Link>
        <Link className="link" to="/Aktsiya">Доставка </Link>
        <Link className="link" to="/Aktsiya">O магазине </Link>
        <Link className="link" to="/Aktsiya">Блог </Link>
